...
class Ui_MainWin(object):
    def setupUi(self, MainWin):
        ...
        MainWin.setMinimumSize(QtCore.QSize(600, 280))
        MainWin.setMaximumSize(QtCore.QSize(600, 280))
        ...
        self.checkBox_Evbus = QtWidgets.QCheckBox(MainWin)
        self.checkBox_Evbus.setGeometry(QtCore.QRect(290, 40, 71, 16))
        self.checkBox_Evbus.setObjectName("checkBox_Evbus")
        self.checkBox_Pbus = QtWidgets.QCheckBox(MainWin)
        self.checkBox_Pbus.setGeometry(QtCore.QRect(400, 40, 71, 16))
        self.checkBox_Pbus.setObjectName("checkBox_Pbus")
        self.comboBox_choseNode = QtWidgets.QComboBox(MainWin)
        self.comboBox_choseNode.setGeometry(QtCore.QRect(510, 101, 81, 31))
        self.comboBox_choseNode.setObjectName("comboBox_choseNode")
        self.comboBox_choseNode.addItem("")
    ...
    def retranslateUi(self, MainWin):
        ...
        self.checkBox_Evbus.setText(_translate("MainWin", "Evbus"))
        self.checkBox_Pbus.setText(_translate("MainWin", "Pbus"))
        self.comboBox_choseNode.setItemText(0, _translate("MainWin", "选择节点"))
